//+------------------------------------------------------------------+
//| File: London_SwingTrend_GBPJPY_H1.mq5                            |
//| EA  : London_SwingTrend_GBPJPY_H1                                |
//| Ver : 1.1.0                                                      |
//|                                                                  |
//| London Swing Trend (GBPJPY / H1)                                 |
...
//|                                                                  |
//| Notes                                                            |
//| - Attach ONLY to GBPJPY H1 chart                                 |
...
// ------------------------- Identity / Tracking ---------------------
input string InpEaId          = "LDN_ST_GBPJPY_H1";
input string InpEaName        = "London_SwingTrend_GBPJPY_H1";
...
{
   if(_Symbol != "GBPJPY")
      Print("Warning: This EA is intended for GBPJPY. Current symbol=", _Symbol);
